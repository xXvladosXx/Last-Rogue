...
public partial class MetaEntity {
    ...
    public Code.Gameplay.Meta.Features.Storage.Gold gold { get { return (Code.Gameplay.Meta.Features.Storage.Gold)GetComponent(MetaComponentsLookup.Gold); } }
    ...
    public MetaEntity AddGold(float newValue) {
        ...
        var component = (Code.Gameplay.Meta.Features.Storage.Gold)CreateComponent(index, typeof(Code.Gameplay.Meta.Features.Storage.Gold));
