...
public partial class GameEntity {
    ...
    public Code.Common.CommonComponents.ViewPrefab viewPrefab { get { return (Code.Common.CommonComponents.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    ...
    public GameEntity AddViewPrefab(Code.Infrastructure.View.EntityBehaviour newValue) {
        ...
        var component = (Code.Common.CommonComponents.ViewPrefab)CreateComponent(index, typeof(Code.Common.CommonComponents.ViewPrefab));
