...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Abilities.AbilityComponents.ParentAbility parentAbility { get { return (Code.Gameplay.Features.Abilities.AbilityComponents.ParentAbility)GetComponent(GameComponentsLookup.ParentAbility); } }
    ...
    public GameEntity AddParentAbility(Code.Gameplay.Features.Abilities.AbilityId newValue) {
        ...
        var component = (Code.Gameplay.Features.Abilities.AbilityComponents.ParentAbility)CreateComponent(index, typeof(Code.Gameplay.Features.Abilities.AbilityComponents.ParentAbility));
