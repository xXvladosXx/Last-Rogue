...
public partial class GameEntity {
    ...
    public Code.Common.CommonComponents.ViewPath viewPath { get { return (Code.Common.CommonComponents.ViewPath)GetComponent(GameComponentsLookup.ViewPath); } }
    ...
    public GameEntity AddViewPath(string newValue) {
        ...
        var component = (Code.Common.CommonComponents.ViewPath)CreateComponent(index, typeof(Code.Common.CommonComponents.ViewPath));
